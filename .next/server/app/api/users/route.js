...
;// CONCATENATED MODULE: ./src/db/models/user.js
...
var jsonwebtoken = __webpack_require__(9518);
...
async function PUT(request) {
    try {
        ...
        const existingUser = await models_user.findOne().or([
            {
                login: email
            },
            {
        ...
        if (!existingUser) return next_response/* default */.Z.json("404", {
            status: 404
        });
        const isPasswordCorrect = await bcryptjs_default().compare(password, existingUser.password);
        if (!isPasswordCorrect) return next_response/* default */.Z.json("pass", {
            status: 404
        });
...
async function POST(request) {
    try {
        ...
        await (0,connect/* default */.Z)();
        const existingUser = await models_user.findOne({
            "$or": [
                {
                    login: login
                },
        ...
        if (existingUser) return next_response/* default */.Z.json("User already exist.", {
            status: 409
        });
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Fusers%2Froute&name=app%2Fapi%2Fusers%2Froute&pagePath=private-next-app-dir%2Fapi%2Fusers%2Froute.js&appDir=D%3A%5CRa%20Group%5Cwave%20projects%5Ccity-group-almaty%5Csrc%5Capp&appPaths=%2Fapi%2Fusers%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!
    ...
    const options = {"definition":{"kind":"APP_ROUTE","page":"/api/users/route","pathname":"/api/users","filename":"route","bundlePath":"app/api/users/route"},"resolvedPagePath":"D:\\Ra Group\\wave projects\\city-group-almaty\\src\\app\\api\\users\\route.js","nextConfigOutput":""}
...
var __webpack_exports__ = __webpack_require__.X(0, [381,625,260], () => (__webpack_exec__(6422)));
